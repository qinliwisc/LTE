function LTE_disc_Guo(ep_value,N_value,origin_dis)
...
Lr = 8; Nr = Lr*N_value; dr = Lr/Nr; r0 = 0:dr:Lr;
Nt = 240; dt = 2*pi/Nt; theta0 = -pi+dt/2:dt:pi-dt/2;
[rr,tt] = meshgrid(r0,theta0);

epsilon = 0;%2^(-ep_value);
...
save(['Guo_ep/ep00_v0_R',num2str(Lr),'.mat']);
