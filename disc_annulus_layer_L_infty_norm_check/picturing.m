...
print(gcf,'-depsc2','revision/cont_dent_bump3');
close(handle_f);


handle_f = figure(1);
subplot(3,1,1);plot(bump_fun.theta0,bump,'.-');ylabel('\partial_\eta f_1','fontsize',20);xlim([-1 1]);
subplot(3,1,2);plot(bump_fun.theta0,dent,'.-');ylabel('\partial_\eta f_2','fontsize',20);xlim([-1 1]);
subplot(3,1,3);plot(bump_fun.theta0,soln,'.-');ylabel('\partial_\eta F','fontsize',20);xlim([-1 1]);
xlabel('\theta','fontsize',20);
...
handle_f = figure(1);
subplot(3,1,1);plot(bump_fun.theta0,(bump-mean(bump))./sin(theta0)','.-');ylabel('\partial_\eta f_1','fontsize',20);
title('(f-<f>)/sin\theta','fontsize',20)
subplot(3,1,2);plot(bump_fun.theta0,(dent-mean(dent))./sin(theta0)','.-');ylabel('\partial_\eta f_2','fontsize',20);
subplot(3,1,3);plot(bump_fun.theta0,(soln-mean(soln))./sin(theta0)','.-');ylabel('\partial_\eta F','fontsize',20);
xlabel('\theta','fontsize',20);
