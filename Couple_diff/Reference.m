function Reference(sigma_value,epsilon_value)
% %=============
% reference solution
% linear transport
...
% boundary data
fboundary.fun =  inline('abs(v)');%'abs(v)');%-v+1');
...
%     boundary_l = feval(fboundary.fun,Vp,t);
%     boundary_r = feval(fboundary.fun,Vm,t);
