function Reference_compatible_test(sigma_value,epsilon_value)
% %=============
% reference solution
% linear transport
...
if nargin == 0
    clear;
    sigma_value = 128; epsilon_value = 1/128;
end
% discretization x
% dx = 0.0001;
...
[boundary_fund_adjust,eta_fund] = ...
    boundary_computing(V_full,Weight,H_poly,boundary_fund);

phi = eta_fund*ones(Np,Nx);
